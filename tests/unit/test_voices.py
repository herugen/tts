...
class TestVoiceEndpoint:
    ...
    def test_list_voices_success(self, test_client, test_db, sample_upload, sample_voice):
        """测试列举音色成功"""
        # 先创建上传记录和音色记录
        upload_repo = UploadRepository(test_db)
    ...
    def test_delete_voice_success(self, test_client, test_db, sample_upload, sample_voice):
        """测试删除音色成功"""
        # 先创建记录
        upload_repo = UploadRepository(test_db)
        voice_repo = VoiceRepository(test_db)
